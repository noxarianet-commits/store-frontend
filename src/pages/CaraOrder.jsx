        ...
        <div className="min-h-screen text-ink p-6 md:p-12 font-sans">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <h1 className="text-3xl font-extrabold text-ink">Cara Order</h1>
                </div>
                
                <div className="space-y-4">
                    {/* Step 1 */}
                    <div className="bg-white border border-brandBorder rounded-2xl p-6 flex gap-4 shadow-sm hover:border-brandBorder transition-colors">
                        <div className="w-8 h-8 rounded-full bg-purple-50 text-brand flex items-center justify-center font-bold shrink-0">1</div>
                        <div>
                            <h3 className="text-ink font-bold mb-2">Pilih Produk</h3>
                    ...
                    {/* Step 2 */}
                    <div className="bg-white border border-brandBorder rounded-2xl p-6 flex gap-4 shadow-sm hover:border-brandBorder transition-colors">
                        <div className="w-8 h-8 rounded-full bg-purple-50 text-brand flex items-center justify-center font-bold shrink-0">2</div>
                        <div>
                            <h3 className="text-ink font-bold mb-2">Isi Data Pesanan</h3>
                    ...
                    {/* Step 3 */}
                    <div className="bg-white border border-brandBorder rounded-2xl p-6 flex gap-4 shadow-sm hover:border-brandBorder transition-colors">
                        <div className="w-8 h-8 rounded-full bg-purple-50 text-brand flex items-center justify-center font-bold shrink-0">3</div>
                        <div>
                            <h3 className="text-ink font-bold mb-2">Pilih Metode Pembayaran</h3>
                    ...
                    <div className="bg-white border border-brandBorder rounded-2xl p-6 flex gap-4 shadow-sm hover:border-brandBorder transition-colors">
                        ...
                        <div>
                            <h3 className="text-ink font-bold mb-2">Selesai! Terima Pesanan</h3>
