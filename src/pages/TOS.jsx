            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white border border-brandBorder rounded-3xl p-6 md:p-8 space-y-6 text-sm text-slate-600 leading-relaxed shadow-sm hover:border-brandBorder transition-colors">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-ink font-bold text-base">1. Ketentuan Umum</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-ink font-bold text-base">2. Kebijakan Pembayaran</h2>
                    ...
                    <div className="space-y-4">
                        <h2 className="text-ink font-bold text-base">3. Kebijakan Produk & Penggunaan</h2>
                        <ul className="list-disc pl-5 space-y-2">
                    ...
                    <div className="space-y-4">
                        <h2 className="text-ink font-bold text-base">4. Pembatalan & Refund</h2>
